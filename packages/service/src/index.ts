...
if (import.meta.main) {
  ...
  // Marketing page at the root. Same guard: if the directory is missing the
  // feature is simply off and / redirects to the app.
  const landingDir = new URL('../../landing/dist', import.meta.url).pathname;
